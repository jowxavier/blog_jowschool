...
<body>
    <div class="container">
        ...
        <?php if (isset($_SESSION['message'])) { ?>
            ...
            <br>
        <?php } ?>
        <a class="btn btn-success" href="usuario.html">Novo Cadastro</a><br><br>
        <?php
            ...
            $usuario = new Usuario();
            // Acessa o método listar de usuario
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="scripts/usuario.php?edit=<?php echo $row['id']; ?>"><i class="fa fa-edit btn btn-info"></i></a>
                                <a href="scripts/usuario.php?remove=<?php echo $row['id']; ?>"><i class="fa fa-remove btn btn-danger" href="scripts/index.php"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
